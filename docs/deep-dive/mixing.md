...
- Use ++up++ / ++down++ or the touch strip to adjust
...
Hold ++play++ and press ++up++ / ++down++ to adjust the master output volume.
...
Press and release ++track++ to enter Track mode, then press one of ++9++,
++10++, ++11++ to select an effect track.
