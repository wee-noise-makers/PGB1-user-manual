...
Press ++song++ to enter Song Mode. The Song LED will light up.
...
- Press ++1++ to ++12++ to select and **queue** a song part
- The queued part will start playing after the current part completes
- Hold ++song++ and press ++1++ to ++12++ to select **without** queuing
...
Press ++13++ to ++16++ to enter chord progression editing.
...
2. Press ++right++ to go past the last setting
...
1. Use ++up++ / ++down++ to select a scale (Major, Minor, Modal)
2. Press ++a++ to generate a random progression
3. Press ++a++ again to try different progressions
