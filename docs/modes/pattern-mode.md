...
Press ++pattern++ to enter Pattern Mode. The Pattern LED will light up.
...
Navigate to the length setting and use ++up++ / ++down++ to adjust.
...
Use ++up++/++down++ to enable/ disable linking.
